...
public abstract class Datum implements Comparator<Datum[]>, Comparable<Datum>{  
	...
	public static class Int extends Datum {
		...
		@Override
		public String toOnlyString() { return Integer.toString(i);	}
	...
	public static class Flt extends Datum {
		...
		@Override
		public String toOnlyString() {return Float.toString(f);}
	}
	...
	public static class Str extends Datum {
		...
		public String toOnlyString(){return s;}
	}
	...
	public static class Bool extends Datum {
		...
		@Override
		public String toOnlyString() {return b ? "true" : "false"; }
